...
const fieldClasses =
  'w-full rounded-xl border border-navy-200 bg-white px-4 py-3 text-sm text-navy-900 placeholder:text-navy-400 transition-colors focus:border-mint-400 focus:outline-none focus:ring-2 focus:ring-mint-400/30'
  ...
  if (status === 'success') {
    return (
      <motion.div
        ...
        className="flex flex-col items-center gap-3 rounded-2xl border border-mint-200 bg-mint-50 p-10 text-center"
      >
        <CheckCircle2 className="h-10 w-10 text-mint-600" />
        <h3 className="font-display text-xl font-semibold text-navy-900">Message bien reçu</h3>
        ...
        <button onClick={() => setStatus('idle')} className="mt-2 text-sm font-semibold text-mint-600 hover:text-mint-500">
