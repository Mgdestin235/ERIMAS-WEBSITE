      ...
      >
        <div className="relative h-44 w-full overflow-hidden bg-gradient-to-br from-navy-700 to-navy-950">
          {project.coverImage ? (
            ...
            <div className="flex h-full items-center justify-center font-display text-3xl text-navy-500">
        ...
        <div className="flex flex-1 flex-col p-6">
          ...
          <h3 className="mt-3 font-display text-lg font-semibold text-cream">{project.client}</h3>
          <p className="mt-2 line-clamp-2 flex-1 text-sm text-navy-300">{project.summary}</p>
